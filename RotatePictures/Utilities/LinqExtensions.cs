...
namespace RotatePictures.Utilities
{
	public static class LinqExtensions
	{
		...
		public static IEnumerable<T> Union<T>(this IEnumerable<T> a, IEnumerable<T> b, Func<T, T, bool> cmpr, Func<T, int> hashCode = null) => a.Intersect(b, new LinqComparer<T>(cmpr, hashCode));
	}
}
